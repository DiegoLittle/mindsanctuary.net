...
export function PersonalWelcomeHTML(emailID, name, email) {
  return `<!DOCTYPE html>
        ...
        <body class="bg-gray-100" style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f3f4f6;">
          <div role="article" aria-roledescription="email" aria-label="Welcome to Mind Sanctuary" lang="en">
                              ...
                              <td>
                                <div class="text-lg mx-auto" style="margin-left: auto; margin-right: auto; font-size: 18px;">
                                    <div>
                                        Hi ${name},
                                        <p>
                                          I’m Diego, the founder of Mind Sanctuary, and I’d like to personally thank you for signing up to our product.
                                          </p>
                                          <p>
            ...
            <img src="https://www.mindsanctuary.net/collect/collect.png?email=${email}&emailID=${emailID}" alt="" title="" style="display:block" width="1" height="1" />
          </div>
        </body>
        </html>
...
export default function sendEmail(
  ...
  if (process.env.NODE_ENV == 'development') {
    ...
    transporter = nodemailer.createTransport({
      ...
      // secure: true,
      // dkim: {
      //         domainName: 'mindsanctuary.net',
      //         keySelector: 'default', // The key you used in your DKIM TXT DNS Record
      //         privateKey: 'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCfT1e+guOniAayH7QgdkCYJtOMaGKTg8RwktT5Q6f4sbu1ZBGay0Oa4jWq8Jep2RCRpC9aBBwSAFAQ/fBRFHT5z8pwI7AVbtBHn1YwO14/KaOQ17YlhoTTK2moAMJ0FvvkTWgS62ZUwHHTyxA78tQz7EYcWhFl42ZZekFO3MOJywIDAQAB', // Content of you private key
      // }
    })
  }

  var mailData
  if (template.name == 'Personal Welcome') {
    mailData = {
      from: '"Diego at Mind Sanctuary" <diego@mindsanctuary.net>',
      to: email,
      subject: `Welcome to Mind Sanctuary`,
      text: ` Thank you for signing up! We would love if you shared it with your friends and gave back any suggestions.
    `,
      html: PersonalWelcomeHTML(emailID, name, email),
