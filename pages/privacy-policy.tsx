...
export async function getServerSideProps() {
  // let test = getPostBySlug('privacy-policy')
  // console.log(test)
  let test = `
  **PRIVACY NOTICE**
...
This privacy notice for Synesthesia Studio, LLC (" **Company** ," "**we**," "**us**," or "**our**"), describes how and why we might collect, store, use, and/or share ("**process**") your information when you use our services ("**Services**"), such as when you:

*   Visit our website at mindsanctuary.net , or any website of ours that links to this privacy notice

*   Engage with us in other related ways ― including any sales, marketing, or events

**Questions or concerns?** Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at diegolittle@protonmail.com .
...
**What personal information do we process?** When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Synesthesia Studio, LLC and the Services, the choices you make, and the products and features you use. Click [here](#personalinfo) to learn more.
...
**How do I exercise my rights?** The easiest way to exercise your rights is by filling out our data subject request form available [here](https://app.termly.io/notify/c4a283f6-2625-48e9-82c6-c833f93608ee) , or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.



Want to learn more about what Synesthesia Studio, LLC does with any information we collect? Click [here](#toc) to review the notice in full.
...
If you have questions or comments about your privacy rights, you may email us at diego@mindsanctuary.net.
...
You may contact us by email at diego@mindsanctuary.net, by visiting [https://mindsanctuary.net/contact](https://mindsanctuary.net/contact), or by referring to the contact details at the bottom of this document.
...
Synesthesia Studio, LLC has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. Synesthesia Studio, LLC will not sell personal information in the future belonging to website visitors, users, and other consumers.
...
To exercise these rights, you can contact us by email at diego@mindsanctuary.net, by visiting [https://mindsanctuary.net/contact](https://mindsanctuary.net/contact), or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.
...
If you have questions or comments about this notice, you may email us at diego@mindsanctuary.net or by post to:



Synesthesia Studio, LLC

6105 Homestead Trail
...
Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking [here](https://app.termly.io/notify/c4a283f6-2625-48e9-82c6-c833f93608ee).


This privacy policy was created using Termly's [Privacy Policy Generator](https://termly.io/products/privacy-policy-generator).`

  let markdownContent = await markdownToHtml(test)
  // markdownContent =markdownContent.replace('<pre><code>','')
  // markdownContent = markdownContent.replace('</code></pre>','')
  return {
    props: {
